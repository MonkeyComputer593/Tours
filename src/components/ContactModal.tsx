            ...
            <div className="p-6 sm:p-8 overflow-y-auto max-h-[90vh] sm:max-h-none">
              ...
              {isSent ? (
                <div className="text-center py-12">
                  ...
                  <h4 className="text-2xl font-black text-gray-900 mb-2">{isEnglish ? 'Message Sent!' : '¡Mensaje Enviado!'}</h4>
              ...
              <div className="mt-8 pt-8 border-t border-gray-100 flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-lg font-black text-gray-900">+593 96 190 6731</p>
                </div>
              </div>
            </div>
          </motion.div>
